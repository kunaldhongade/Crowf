...
function Header(props) {
    ...
    const handleDrawerToggle = () => {
        ...
        <Typography variant="h6" sx={{ my: 2, fontFamily: 'Russo One', textAlign: "center" }}>
            Crowf
        </Typography>
    };
        ...
        <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
            ...
            <List>
                <ListItem key={"campaign"} disablePadding>
                    <Link href={'/'}><span active={Router.pathname == "/" ? true : false}>
                ...
                <ListItem key={"create campaign"} disablePadding>
                    <Link href={'/createcampaign'}><span active={Router.pathname == "/createcampaign" ? true : false}>
                        <ListItemButton sx={{ textAlign: "center" }}>
                ...
                <ListItem key={"dashboard"} disablePadding>
                    <Link href={'/dashboard'}><span active={Router.pathname == "/dashboard" ? true : false}>
                        <ListItemButton sx={{ textAlign: "center" }}>
                ...
                <Toolbar>
                    ...
                    <Link href={'/'}>
                        <Typography
                            ...
                            component="div"
                            noWrap
                            sx={{ flexGrow: 1, display: { xs: "none", sm: "block", fontFamily: "Russo One" } }}
                        >
                            Crowf
                        </Typography>
                    </Link>
